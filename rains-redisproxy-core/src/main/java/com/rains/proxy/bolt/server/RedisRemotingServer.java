 ...
 * @author ly-dourx
 */
public class RedisRemotingServer extends AbstractRemotingServer {
    ...
    public RedisRemotingServer() {
        this(false);
    }


    public RedisRemotingServer(boolean manageConnection) {
        this(0, manageConnection);
    }


    public RedisRemotingServer(int port) {
        this(port, false);
    }

    public RedisRemotingServer(String ip, int port) {
        this(ip, port, false);
    }
     ...
     */
    public RedisRemotingServer(int port, boolean manageConnection) {
        super(port);
     ...
     * @param manageConnection true to enable connection management feature
     */
    public RedisRemotingServer(String ip, int port, boolean manageConnection) {
        super(ip, port);
        /* server connection management feature enabled or not, default value false, means disabled. */
        if (manageConnection) {
            option(BoltServerOption.SERVER_MANAGE_CONNECTION_SWITCH, true);
     ...
     */
    public RedisRemotingServer(int port, boolean manageConnection, boolean syncStop) {
    ...
    protected void initRpcRemoting() {
        this.rpcRemoting = new RedisBoltServerRemoting(new RedisBoltCommandFactory(), this.addressParser,
