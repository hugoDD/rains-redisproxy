...
public class RedisBoltCommandFactory implements CommandFactory {
    ...
    @Override
    public RedisResponseCommand createResponse(final Object responseObject,
                                             final RemotingCommand requestCmd) {
        RedisResponseCommand response = new RedisResponseCommand(requestCmd.getId(), responseObject);
    ...
    @Override
    public RedisResponseCommand createExceptionResponse(int id, String errMsg) {
        return createExceptionResponse(id, null, errMsg);
    }

    @Override
    public RedisResponseCommand createExceptionResponse(int id, final Throwable t, String errMsg) {
        RedisResponseCommand response = null;
        if (null == t) {
            response = new RedisResponseCommand(id, createServerException(errMsg));
        } else {
            response = new RedisResponseCommand(id, createServerException(t, errMsg));
        }
    ...
    @Override
    public RedisResponseCommand createExceptionResponse(int id, ResponseStatus status) {
        RedisResponseCommand responseCommand = new RedisResponseCommand();
    ...
    @Override
    public RedisResponseCommand createExceptionResponse(int id, ResponseStatus status, Throwable t) {
        RedisResponseCommand responseCommand = this.createExceptionResponse(id, status);
