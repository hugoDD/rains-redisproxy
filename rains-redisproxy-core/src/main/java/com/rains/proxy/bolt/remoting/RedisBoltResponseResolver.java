 ...
 */
public class RedisBoltResponseResolver {
    ...
    private static Object toResponseObject(ResponseCommand responseCommand) throws CodecException {
        RedisResponseCommand response = (RedisResponseCommand) responseCommand;
     ...
     */
    private static Throwable toThrowable(ResponseCommand responseCommand)  {
        RedisResponseCommand resp = (RedisResponseCommand) responseCommand;
