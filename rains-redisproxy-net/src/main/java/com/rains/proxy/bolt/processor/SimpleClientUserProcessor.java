 ...
 */
package com.rains.proxy.bolt.processor;
 ...
 */
public class SimpleClientUserProcessor extends SyncUserProcessor<IRedisCommand> {
    ...
    @Override
    public Object handleRequest(BizContext bizCtx, IRedisCommand request) throws Exception {
        ...
        Assert.assertEquals(IRedisCommand.class, request.getClass());
        ...
        processTimes(request);
        if (!delaySwitch) {
            return request.toString();//IRedisCommand.DEFAULT_CLIENT_RETURN_STR;
        }
        try {
    ...
    public String interest() {
        return IRedisCommand.class.getName();
    }
...
//    }
    ...
    // ~~~ private methods
    private void processTimes(IRedisCommand req) {
